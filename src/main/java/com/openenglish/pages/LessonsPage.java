...
public class LessonsPage {
    private SelenideElement text = $(By.xpath(".//*[@class='instructions']")),
            ...
            myNotesTabGuardarNotaDisabledButton = $(By.xpath(".//a[@class='orange-btn btn-note disabled save']")),
            myNotesTabGuardarNotaVisibleButton = $(By.xpath(".//a[@class='orange-btn btn-note save']")),
            myNotesTabVerMiCuadernoDeNotasLink = $(By.xpath(".//*[@id='tab-notes']//a[contains(text(), 'Ver mi Cuaderno de Notas')]")),
