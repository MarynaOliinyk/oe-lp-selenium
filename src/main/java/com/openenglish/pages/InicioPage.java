...
public class InicioPage {
    private SelenideElement userInfoElement = $(By.xpath(".//*[@id='student-info']//div[@class='student-level']")),
            ...
            preferenciasCuentaSuboptionButton = $(By.id("nav-preferences")),
            inicioLink = $(By.id("nav-home")),
            cuentaSuboptions = $(By.id("account-menu-nav")),
            ...
            verificaTuSistema = $(By.id("test-your-system")),
            adobeConnectGuiaRapida = $(By.id("adobe-quick-guide")),
