...
public class TestData {
    ...
    public static class Preferences {
        public static final String PREFERENCES_MI_PERFIL_TAB_TEXT = getProperty("preferences.miperfil.tab.text"),
                ...
                PREFERENCES_FECHA_DE_NACIMIENTO_PLACEHOLDER_TEXT = getProperty("preferences.fecha.de.nacimiento.placeholder.text"),
                PREFERENCES_NOMBRE_VISIBLE_A_OTROS_PLACEHOLDER_TEXT = getProperty("preferences.nombre.visible.otros.placeholder.text"),
                PREFERENCES_NIVEL_ACADEMICO_PLACEHOLDER_TEXT = getProperty("preferences.nivel.academico.placeholder.text"),
                ...
                PREFERENCES_CONFIRMAR_CONTRASENA_PLACEHOLDER_TEXT = getProperty("preferences.confirmar.contrasena.placeholder.text"),
                PREFERENCES_IDIOMA_DE_PREFERENCIA_PLACEHOLDER_TEXT = getProperty("preferences.idioma.de.preferencia.placeholder.text"),
                ...
                PREFERENCES_PAIS_VALUE_BRASIL_TEXT = getProperty("preferences.pais.value.brasil.text"),
                PREFERENCES_PAIS_VALUE_AFGANISTAN_TEXT = getProperty("preferences.pais.value.afganistan.text"),
                PREFERENCES_PAIS_VALUE_ALBANIA_TEXT = getProperty("preferences.pais.value.albania.text"),
