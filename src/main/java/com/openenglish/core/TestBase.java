...
public class TestBase extends DriverBase {
    ...
    protected String talkNowHeaderText = getProperty("talknow.header.text");
    protected String testYourSystemHeaderText = getProperty("testyoursystem.header.text");
    protected String abodeConnectText = getProperty("abodeconnect.header.text");
    protected String containsPdfFile = getProperty("contains.pdf.file");
