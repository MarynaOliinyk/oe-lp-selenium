...
public class C131VerifyNombreFieldTest extends TestBase {
    ...
    private String lessThenForty = getInstance().getProperty("field.lenth.acceptense.message");
    private String charQuantity = getInstance().getProperty("char.quantity");
