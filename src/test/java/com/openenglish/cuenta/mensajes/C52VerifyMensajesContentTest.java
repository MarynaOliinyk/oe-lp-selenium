...
import static com.openenglish.core.TestData.MensajesPage.AVISO;
import static com.openenglish.core.TestData.MensajesPage.ENVIADO_POR;
import static com.openenglish.core.TestData.MensajesPage.FECHA_HORA;
import static com.openenglish.core.TestData.MensajesPage.SIN_LEER;
...
public class C52VerifyMensajesContentTest extends DriverBase {
    ...
    public void verifyMensajesContentTest() {
        ...
        mp.getSinLeer().shouldBe(visible, text(SIN_LEER));
        mp.getAvisos().shouldBe(visible);
        mp.getFechaHoraColumnTitle().shouldBe(visible, exactText(FECHA_HORA));
        ...
        mp.getEnviadoPorColumnTitle().shouldBe(visible, exactText(ENVIADO_POR));
        mp.getEnviadoPhoto().shouldBe(visible);
        mp.getEnviadoUserName().shouldBe(visible, not(empty));
        mp.getAvisoColumnTitle().shouldBe(visible, exactText(AVISO));
