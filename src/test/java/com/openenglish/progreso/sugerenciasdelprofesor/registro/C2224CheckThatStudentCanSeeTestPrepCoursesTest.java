...
import static com.openenglish.core.TestData.History.TIPO_TEXT;
...
public class C2224CheckThatStudentCanSeeTestPrepCoursesTest extends DriverBase {
    ...
    public void checkThatStudentCanSeeTestPrepCoursesTest() {
        ...
        assertFalse(historyPage.isAllTheListContainsText($$(By.xpath(historyPage.getTipoTableEllements())), TIPO_TEXT));
        historyPage.getAddTypeButton().click();
        historyPage.getSearchTypePractice().shouldBe(visible).click();
        historyPage.getAddTypeButton().click();
        assertTrue(historyPage.isAllTheListContainsText($$(By.xpath(historyPage.getTipoTableEllements())), TIPO_TEXT));
